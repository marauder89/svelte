    ...
    var e, t = {
        2250: () => {
            ...
            const e = document.querySelectorAll(".navbar-nav .dropdown, .navbar-nav .dropend"),
                t = ["mouseenter", "focusin"], o = ["mouseleave", "click", "focusout"];
            ...
            const e = document.querySelectorAll(".navbar-togglable"), t = document.querySelectorAll(".navbar-collapse"),
                o = ["load", "scroll"];
            let n = !1;
            ...
            "use strict";
            var n = o(5169), a = o(2442), r = o.n(a), l = (o(1105), o(7541), o(3031), o(4878)), i = o(2711), d = o.n(i);
            d().init({duration: 700, easing: "ease-out-quad", once: !0, startEvent: "load"}), window.AOS = d();
            var c = o(765), s = o.n(c);
            document.querySelectorAll("[data-bigpicture]").forEach((function (e) {
                e.addEventListener("click", (function (t) {
                    t.preventDefault();
                    const o = JSON.parse(e.dataset.bigpicture), n = {...{el: e, noLoader: !0}, ...o};
                    s()(n)
                }))
            ...
            var v = o(7802), g = o.n(v), y = o(6344), b = o.n(y), S = o(2157), E = o.n(S);
            const O = document.querySelectorAll(".highlight");
            g().registerLanguage("xml", E()), g().registerLanguage("javascript", b()), O.forEach((e => {
                g().highlightBlock(e)
            })), window.hljs = g();
            var L = o(7564), q = o.n(L), x = o(3391), A = o.n(x);
            const j = document.querySelectorAll("[data-isotope]"), k = document.querySelectorAll("[data-filter]");
            j.forEach((function (e) {
                ...
                e.addEventListener("click", (function (t) {
                    t.preventDefault();
                    const o = e.dataset.filter, n = e.dataset.bsTarget;
            ...
            T.forEach((e => {
                e.addEventListener("change", (e => {
                    const t = e.target, o = t.checked, n = t.dataset.target;
                    document.querySelectorAll(n).forEach((e => {
                        const t = e.dataset.annual, n = e.dataset.monthly,
            ...
            document.querySelectorAll("[data-quill]").forEach((e => {
                const t = {
                    ...
                    theme: "snow", ...e.dataset.quill ? JSON.parse(e.dataset.quill) : {}
                };
                new (I())(e, t)
            })), window.Quill = I();
            var z = o(3002), C = o.n(z);
            const D = {
            ...
            var M = o(3614), H = o.n(M);
            document.querySelectorAll("[data-typed]").forEach((e => {
                const t = {
                    typeSpeed: 40,
                    backSpeed: 40,
                    backDelay: 1e3,
                    loop: !0, ...e.dataset.typed ? JSON.parse(e.dataset.typed) : {}
                };
                new (H())(e, t)
            })), window.Typed = H()
        }
